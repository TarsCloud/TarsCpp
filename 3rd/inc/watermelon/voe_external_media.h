...
public:
    ...
    virtual void Process(const int channel, const ProcessingTypes type,
                         ...
                         const int samplingFreq, const int channels) = 0;
...
public:
    ...
    // Set callback to get audio data after APM processing
    virtual int RegisterAPMDataOutput(void* cookie, void* callback) = 0;
    virtual int DeRegisterAPMDataOutput() = 0;
